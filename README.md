...
| 项 | 状态 |
|---|---|
| 办公室开放时间 | ✅ 周一至周五 09:00–15:00（来自 Google 资料）。写在电话号码底下——人查开放时间时想知道的就是"什么时候打过去有人接"。Google 上那条「周日 10:00–12:30」是聚会加茶点，**不是**办公室办公，两者没有混写。 |
...
> **地址、办公时间、无障碍设施都来自 Google 商家资料，请教会核一眼。**
> 网站本身从未公布过地址；这个地址另经 OpenStreetMap（该建筑标记为
> place_of_worship）、Zenbu、Kompass 等多个独立目录交叉验证，电话也一致。
> 办公时间尤其值得确认——Google 上的营业时间常年不更新。
>
> **停车是唯一由教会直接告知的**：教会停车场或路边均可，但**不要占用旁边
> 咖啡厅的车位**，那会影响邻居的生意。这句话在「第一次来」页面上说一次，
> 比事后在人家停车场立个牌子好，也是教会该有的样子。
> 只有无障碍车位/入口那一句仍来自 Google，未经确认。
